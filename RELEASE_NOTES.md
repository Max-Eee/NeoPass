...
- Updated the extension backend API base URL to `https://api.neopass.fun` in extension code paths (`popup.js`, `worker.js`, and `data/inject/screenshare.js`).
...
- Bumped extension version to `1.5.5`.
